...
f1.pack()
f2oo=Frame(window)
f2oo.pack(side=BOTTOM)
LebqBrickToys=Button(f1,text="Lebq Brick Minifigure + Castle",font=("Times New Roman",20,"italic"),fg="Red",bg="White")
LebqBrickToys.place(x=200,y=80)
flyingskateboard=Button(f1,text="Here is a flying rc aircaft. A child can fly in it! 100% Safe and easy to use!",font=("Arial",20,"bold"),fg="White",bg="Dark Green")
flyingskateboard.place(x=200,y=160)
realflyingbroomstick=Button(f1,text="Here is a flying broomstick, with a CFM56 jet engine on the back! It is easy to manuever by using the blast buttons on the sides!",font=("Helvetica",20,"bold italic"),fg="Yellow",bg="White")
realflyingbroomstick.place(x=200,y=240)
